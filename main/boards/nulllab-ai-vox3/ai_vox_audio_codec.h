...
class AIVoxAudioCodec : public AudioCodec {
 private:
  ...
  void CreateDuplexChannels(gpio_num_t mclk, gpio_num_t bclk, gpio_num_t ws, gpio_num_t dout, gpio_num_t din) {
    ...
    i2s_std_config_t std_cfg = {
        .clk_cfg = {.sample_rate_hz = (uint32_t)output_sample_rate_, .clk_src = I2S_CLK_SRC_DEFAULT, .mclk_multiple = I2S_MCLK_MULTIPLE_128},
        .slot_cfg = {.data_bit_width = I2S_DATA_BIT_WIDTH_16BIT,
                     ...
                     .bit_shift = true},
        .gpio_cfg =
            {.mclk = mclk, .bclk = bclk, .ws = ws, .dout = dout, .din = din, .invert_flags = {.mclk_inv = false, .bclk_inv = false, .ws_inv = false}},
    };
 ...
 public:
  AIVoxAudioCodec(void *i2c_master_handle,
                  i2c_port_t i2c_port,
